...
my $start_month =
    ...
    $Response->{'Customer'}{'CardStartMonth'} : $dt->month );
...
my $valueCustomerCardIssueNumber =
    ...
    $Response->{'Customer'}{'CardIssueNumber'} : "22");
